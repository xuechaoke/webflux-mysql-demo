...
import static com.ciao.webfluxmysqldemo.util.IdGenerator.generateUUID;
...
public class DefaultR2dbcRepository<T, ID> implements ReactiveCrudRepository<T, ID> {
    ...
    /**
     * Create a new {@link DefaultR2dbcRepository}.
     *
     * @param entity
     ...
     * @since 1.1
     */
    public DefaultR2dbcRepository(RelationalEntityInformation<T, ID> entity, R2dbcEntityOperations entityOperations,
     ...
     */
    public DefaultR2dbcRepository(RelationalEntityInformation<T, ID> entity, DatabaseClient databaseClient,
    ...
    public <S extends T> Mono<S> save(S objectToSave) {
        ...
        if (this.entity.isNew(objectToSave)) {
            BeanUtil.setFieldValue(objectToSave, "id", generateUUID());
